...
class ActiveCampaignAutomaticFields(ActiveCampaignTest):
    """
    ...
    def test_run(self):
        ...
        # For `sms` it requires Professional plan of account. So, removing it from streams_to_test set.
        streams_to_test = streams_to_test - {'contact_conversions', 'sms'}
